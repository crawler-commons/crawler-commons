 ...
 * There are a number of constructor options to describe the following:
 * <ol>
 ...
 * <li><tt>_crawlerVersion</tt>: Version of the user agents personal crawler. If this is not set, 
 * it defaults to the crawler commons maven artifact version.</li>
 * </ol>
 *
 */
...
public class UserAgent implements Serializable {
	...
	static CrawlerCommons cc;
	public static final String DEFAULT_BROWSER_VERSION = "Mozilla/5.0";
	public static final String DEFAULT_CRAWLER_VERSION = cc.getVersion();
