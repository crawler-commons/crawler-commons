 ...
 * Initially copied from HttpComponents
 * Changes: removed synchronization
 *
 */
@NotThreadSafe
public class LocalCookieStore implements CookieStore, Serializable {
   ...
   * If the given ookie has already
   ...
   * Cookies are added individually and in the given array order. If any
   * of the given cookies has already expired it will not be added, but existing
